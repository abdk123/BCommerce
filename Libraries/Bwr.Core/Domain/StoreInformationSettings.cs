...
namespace Bwr.Core.Domain
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether "powered by bwire" text should be displayed.
        /// Please find more info at https://www.b-wire.co/bwire-copyright-removal-key
        /// </summary>
