...
using Bwr.Core.Html.CodeFormatter;
using Bwr.Core.Infrastructure;

namespace Bwr.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the URL tags: [url=https://www.bwire.com]my site[/url]
                // becomes: <a href="https://www.bwire.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]https://www.bwire.com[/url]
                // becomes: <a href="https://www.bwire.com">https://www.bwire.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.bwire.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.bwire.com/Content/Images/Image.jpg">
