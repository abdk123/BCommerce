...
namespace Bwr.Services.Authentication
{
    /// <summary>
    ...
    public static partial class NopAuthenticationDefaults
    {
        ...
        /// </summary>
        public static string ClaimsIssuer => "bwire";
        ...
        /// </summary>
        public static string ExternalAuthenticationErrorsSessionKey => "Bwr.externalauth.errors";
    }
}