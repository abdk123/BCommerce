...
namespace Bwr.Services.Seo
{
    ...
    public static partial class NopSeoDefaults
    {
        ...
        /// </summary>
        public static CacheKey UrlRecordAllCacheKey => new CacheKey("Bwr.urlrecord.all");
        ...
        /// {2} : language ID
        /// </remarks>
        public static CacheKey UrlRecordActiveByIdNameLanguageCacheKey => new CacheKey("Bwr.urlrecord.active.id-name-language-{0}-{1}-{2}");
        ...
        /// {0} : IDs hash
        /// </remarks>
        public static CacheKey UrlRecordByIdsCacheKey => new CacheKey("Bwr.urlrecord.byids-{0}", UrlRecordByIdsPrefixCacheKey);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string UrlRecordByIdsPrefixCacheKey => "Bwr.urlrecord.byids";
        ...
        /// {0} : slug
        /// </remarks>
        public static CacheKey UrlRecordBySlugCacheKey => new CacheKey("Bwr.urlrecord.active.slug-{0}");
