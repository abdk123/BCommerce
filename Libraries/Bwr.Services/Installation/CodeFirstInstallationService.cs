...
using Bwr.Core.Domain.Payments;
...
using Bwr.Core.Security;
using Bwr.Data;
using Bwr.Services.Blogs;
...
namespace Bwr.Services.Installation
{
    /// <summary>
    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        {
            //duplicate of ValidateSeName method of \Bwr.Services\Seo\UrlRecordService.cs (we cannot inject it here)
            if (entity == null)
        ...
        protected virtual void InstallSampleCustomers()
        {
            ...
            //second user
            var secondUserEmail = "steve_gates@bwire.com";
            ...
            //third user
            var thirdUserEmail = "arthur_holmes@bwire.com";
            ...
            //fourth user
            var fourthUserEmail = "james_pan@bwire.com";
            ...
            //fifth user
            var fifthUserEmail = "brenda_lindgren@bwire.com";
            ...
            //sixth user
            var sixthUserEmail = "victoria_victoria@bwire.com";
        ...
        protected virtual void InstallOrders()
        {
            ...
            //first order
            var firstCustomer = _customerRepository.Table.First(c => c.Email == "steve_gates@bwire.com");
            ...
            var firstOrderItem3 = new OrderItem
            {
                ...
                PriceExclTax = 25M,
                OriginalProductCost = decimal.Zero,
                AttributeDescription = "From: Steve Gates &lt;steve_gates@bwire.com&gt;<br />For: Brenda Lindgren &lt;brenda_lindgren@bwire.com&gt;",
                AttributesXml = "<Attributes><GiftCardInfo><RecipientName>Brenda Lindgren</RecipientName><RecipientEmail>brenda_lindgren@bwire.com</RecipientEmail><SenderName>Steve Gates</SenderName><SenderEmail>steve_gates@gmail.com</SenderEmail><Message></Message></GiftCardInfo></Attributes>",
                Quantity = 1,
                DiscountAmountInclTax = decimal.Zero,
                DiscountAmountExclTax = decimal.Zero,
                DownloadCount = 0,
            ...
            var firstOrderGiftcard = new GiftCard
            {
                ...
                RecipientEmail = "brenda_lindgren@bwire.com",
                SenderName = "Steve Gates",
                SenderEmail = "steve_gates@bwire.com",
            ...
            //second order
            var secondCustomer = _customerRepository.Table.First(c => c.Email == "arthur_holmes@bwire.com");
            ...
            //third order
            var thirdCustomer = _customerRepository.Table.First(c => c.Email == "james_pan@bwire.com");
            ...
            //fourth order
            var fourthCustomer = _customerRepository.Table.First(c => c.Email == "brenda_lindgren@bwire.com");
            ...
            //fifth order
            var fifthCustomer = _customerRepository.Table.First(c => c.Email == "victoria_victoria@bwire.com");
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "https://www.facebook.com/bwire",
                TwitterLink = "https://twitter.com/bwire",
                YoutubeLink = "https://www.youtube.com/user/bwire",
        ...
        protected virtual void InstallNews(string defaultUserEmail)
        {
            ...
            var news = new List<NewsItem>
            {
                new NewsItem
                {
                    ...
                    LanguageId = defaultLanguage.Id,
                    Title = "About bwire",
                    Short = "It's stable and highly usable. From downloads to documentation, www.bwire.com offers a comprehensive base of information, resources, and support to the bwire community.",
                    Full = "<p>For full feature list go to <a href=\"https://www.bwire.com\">bwire.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow
                },
                new NewsItem
                {
                    AllowComments = true,
                    LanguageId = defaultLanguage.Id,
                    Title = "bwire new release!",
                    Short = "bwire includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! bwire is a fully customizable shopping cart",
                    Full = "<p>bwire includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow.AddSeconds(1)
                },
                new NewsItem
                {
                    ...
                    Short = "The new bwire store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "Bwr.Services.Messages.QueuedMessagesSendTask, Bwr.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "Bwr.Services.Common.KeepAliveTask, Bwr.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "Bwr.Services.Customers.DeleteGuestsTask, Bwr.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "Bwr.Services.Caching.ClearCacheTask, Bwr.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Bwr.Services.Logging.ClearLogTask, Bwr.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Bwr.Services.Directory.UpdateExchangeRateTask, Bwr.Services",
                    Enabled = true,
                    StopOnError = false
                }
            };
