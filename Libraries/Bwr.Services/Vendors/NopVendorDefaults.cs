...
namespace Bwr.Services.Vendors
{
    /// <summary>
    ...
    public static partial class NopVendorDefaults
    {
        ...
        /// </summary>
        public static CacheKey VendorAttributesAllCacheKey => new CacheKey("Bwr.vendorattribute.all");
        ...
        /// </remarks>
        public static CacheKey VendorAttributeValuesAllCacheKey => new CacheKey("Bwr.vendorattributevalue.all-{0}");
