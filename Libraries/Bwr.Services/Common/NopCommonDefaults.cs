...
namespace Bwr.Services.Common
{
    ...
    public static partial class NopCommonDefaults
    {
        ...
        #region bwire official site

        /// <summary>
        /// Gets a path to request the bwire official site for copyright warning
        /// </summary>
        /// <remarks>
        /// {0} : store URL
        ...
        /// <summary>
        /// Gets a path to request the bwire official site for news RSS
        /// </summary>
        /// <remarks>
        /// {0} : bwire version
        /// {1} : whether the store based is on the localhost
        ...
        /// {4} : language code
        /// </remarks>
        public static string NopNewsRssPath => "bwire-news-rss?version={0}&localhost={1}&hideAdvertisements={2}&storeUrl={3}&language={4}";

        /// <summary>
        /// Gets a path to request the bwire official site to notify about successful installation
        /// </summary>
        /// <remarks>
        /// {0} : bwire version
        /// {1} : whether the store based is on the localhost
        ...
        /// <summary>
        /// Gets a path to request the bwire official site for available categories of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        ...
        /// <summary>
        /// Gets a path to request the bwire official site for available versions of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        ...
        /// <summary>
        /// Gets a path to request the bwire official site for marketplace extensions
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        public static CacheKey AddressAttributesAllCacheKey => new CacheKey("Bwr.addressattribute.all");
        ...
        /// {0} : address attribute ID
        /// </remarks>
        public static CacheKey AddressAttributeValuesAllCacheKey => new CacheKey("Bwr.addressattributevalue.all-{0}");
        ...
        /// {1} : key group
        /// </remarks>
        public static CacheKey GenericAttributeCacheKey => new CacheKey("Bwr.genericattribute.{0}-{1}");
