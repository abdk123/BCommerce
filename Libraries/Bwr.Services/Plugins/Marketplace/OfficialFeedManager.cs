...
namespace Bwr.Services.Plugins.Marketplace
{
    /// <summary>
    /// Represents the official feed manager (plugins from bwire marketplace)
    /// </summary>
    public partial class OfficialFeedManager
    {
        ...
        public virtual IList<OfficialFeedCategory> GetCategories()
        {
            ...
            {
                _logger.Error("No access to the list of plugins. Website www.b-wire.co is not available.", ex);
            }
