...
namespace Bwr.Services.Plugins
{
    /// <summary>
    ...
    public static partial class NopPluginDefaults
    {
        ...
        /// </remarks>
        public static CacheKey AdminNavigationPluginsCacheKey => new CacheKey("Bwr.plugins.adminnavigation-{0}", AdminNavigationPluginsPrefixCacheKey);

        /// <summary>
        /// Gets a key to clear cache
        /// </summary>
        public static string AdminNavigationPluginsPrefixCacheKey => "Bwr.plugins.adminnavigation";
    }
}