...
namespace Bwr.Services.Media
{
    ...
    public static partial class NopMediaDefaults
    {
        ...
        /// {0} : thumb file name
        /// </remarks>
        public static CacheKey ThumbExistsCacheKey => new CacheKey("Bwr.azure.thumb.exists-{0}", ThumbsExistsPrefixCacheKey);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string ThumbsExistsPrefixCacheKey => "Bwr.azure.thumb.exists";
