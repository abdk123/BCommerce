...
using Bwr.Web.Areas.Admin.Models.Affiliates;
using Bwr.Web.Areas.Admin.Models.Blogs;
...
namespace Bwr.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        {
            CreateMap<Bwr.Web.Models.Catalog.CategoryModel, CategoryMobModel>();
            CreateMap<Bwr.Web.Models.Catalog.CategorySimpleModel, CategorySimpleMobModel>();
        }
