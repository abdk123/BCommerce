...
namespace Bwr.Web.Framework.Components
{
    /// <summary>
    /// Base class for ViewComponent in bwire
    /// </summary>
    public abstract class NopViewComponent : ViewComponent
    {
        private void PublishModelPrepared<TModel>(TModel model)
        {
            ...
            //as we do in the /Bwr.Web.Framework/Mvc/Filters/PublishModelEventsAttribute.cs for controllers
