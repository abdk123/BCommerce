...
using Bwr.Web.Framework.Extensions;

namespace Bwr.Web.Framework.TagHelpers.Public
{
    /// <summary>
    /// script tag helper
    /// </summary>
    ...
    public class ScriptTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (_httpContextAccessor.HttpContext.Items["Bwr.IgnoreScriptTagLocation"] != null &&
                Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["Bwr.IgnoreScriptTagLocation"]))
                return;
