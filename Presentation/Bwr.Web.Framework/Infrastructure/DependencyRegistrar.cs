...
using Bwr.Core.Redis;
using Bwr.Data;
using Bwr.Services.Affiliates;
using Bwr.Services.Authentication;
...
using Bwr.Services.ExportImport;
using Bwr.Services.Forums;
using Bwr.Services.Gdpr;
using Bwr.Services.Helpers;
using Bwr.Services.Installation;
using Bwr.Services.Localization;
using Bwr.Services.Logging;
using Bwr.Services.Media;
using Bwr.Services.Media.RoxyFileman;
...
using Bwr.Services.Plugins.Marketplace;
using Bwr.Services.Polls;
using Bwr.Services.Security;
using Bwr.Services.Seo;
using Bwr.Services.Shipping;
using Bwr.Services.Shipping.Date;
using Bwr.Services.Shipping.Pickup;
using Bwr.Services.Stores;
using Bwr.Services.Tasks;
using Bwr.Services.Tax;
using Bwr.Services.Themes;
using Bwr.Services.Topics;
using Bwr.Services.Vendors;
using Bwr.Web.Framework.Mvc.Routing;
using Bwr.Web.Framework.Themes;
using Bwr.Web.Framework.UI;

namespace Bwr.Web.Framework.Infrastructure
{
    /// <summary>
