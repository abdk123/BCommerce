...
namespace Bwr.Plugin.Misc.SendinBlue
{
    ...
    public static class SendinBlueDefaults
    {
        ...
        /// </summary>
        public static string UserAgent => $"bwire-{NopVersion.CurrentVersion}";

        /// <summary>
        /// Gets a URL to edit message template on SendinBlue account
        /// </summary>
        public static string EditMessageTemplateUrl = "https://my.sendinblue.com/camp/template/{0}/message-setup?utm_source=bwire_plugin&utm_medium=plugin&utm_campaign=module_link";
        ...
        /// </summary>
        public static string SynchronizationTask => "Bwr.Plugin.Misc.SendinBlue.Services.SynchronizationTask";
