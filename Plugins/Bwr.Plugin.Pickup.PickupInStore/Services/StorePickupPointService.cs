...
using Bwr.Data;
using Bwr.Plugin.Pickup.PickupInStore.Domain;
using Bwr.Services.Caching;

namespace Bwr.Plugin.Pickup.PickupInStore.Services
{
    /// <summary>
    ...
    public partial class StorePickupPointService : IStorePickupPointService
    {
        ...
        /// {0} : current store ID
        /// </remarks>
        private readonly CacheKey _pickupPointAllKey = new CacheKey("Bwr.pickuppoint.all-{0}");
        private const string PICKUP_POINT_PATTERN_KEY = "Bwr.pickuppoint.";
