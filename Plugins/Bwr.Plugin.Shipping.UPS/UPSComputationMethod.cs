...
using System.Linq;
using Bwr.Core;
using Bwr.Plugin.Shipping.UPS.Domain;
using Bwr.Plugin.Shipping.UPS.Services;
using Bwr.Services.Configuration;
using Bwr.Services.Localization;
using Bwr.Services.Plugins;
using Bwr.Services.Shipping;
using Bwr.Services.Shipping.Tracking;

namespace Bwr.Plugin.Shipping.UPS
{
    /// <summary>
    ...
    public class UPSComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        public override void Install()
        {
            ...
            {
                ["Enums.Bwr.Plugin.Shipping.UPS.PackingType.PackByDimensions"] = "Pack by dimensions",
                ["Enums.Bwr.Plugin.Shipping.UPS.PackingType.PackByOneItemPerPackage"] = "Pack by one item per package",
                ["Enums.Bwr.Plugin.Shipping.UPS.PackingType.PackByVolume"] = "Pack by volume",
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResources("Enums.Bwr.Plugin.Shipping.UPS");
