...
namespace Bwr.Plugin.Tax.FixedOrByCountryStateZip.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<TaxCategory>>
    {
        ...
        /// </summary>
        public static CacheKey ALL_TAX_RATES_MODEL_KEY = new CacheKey("Bwr.plugins.tax.fixedorbycountrystateziptaxrate.all", TAXRATE_PATTERN_KEY);
        public static CacheKey TAXRATE_ALL_KEY = new CacheKey("Bwr.plugins.tax.fixedorbycountrystateziptaxrate.taxrate.all", TAXRATE_PATTERN_KEY);
        
        public const string TAXRATE_PATTERN_KEY = "Bwr.plugins.tax.fixedorbycountrystateziptaxrate.";
