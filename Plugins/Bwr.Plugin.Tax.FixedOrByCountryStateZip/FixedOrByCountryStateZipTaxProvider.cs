...
using Bwr.Plugin.Tax.FixedOrByCountryStateZip.Infrastructure.Cache;
...
namespace Bwr.Plugin.Tax.FixedOrByCountryStateZip
{
    /// <summary>
    ...
    public class FixedOrByCountryStateZipTaxProvider : BasePlugin, ITaxProvider
    {
        ...
        {
            if (!(_httpContextAccessor.HttpContext.Items.TryGetValue("Bwr.TaxTotal", out var result) && result is TaxTotalResult taxTotalResult))
            {
                ...
                _httpContextAccessor.HttpContext.Items.TryAdd("Bwr.TaxTotal", taxTotalResult);
            }
