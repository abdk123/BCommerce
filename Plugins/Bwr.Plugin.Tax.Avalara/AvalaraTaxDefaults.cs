...
namespace Bwr.Plugin.Tax.Avalara
{
    ...
    public class AvalaraTaxDefaults
    {
        ...
        /// </summary>
        public static string ApplicationName => "bwire-AvalaraTaxRateProvider|a0o33000004BoPM";

        /// <summary>
        /// Gets the Avalara tax provider version (used a bwire version here)
        /// </summary>
        ...
        /// {7} - Zip postal code
        /// </remarks>
        public static CacheKey TaxRateCacheKey => new CacheKey("Bwr.avalara.taxrate-{0}-{1}-{2}-{3}-{4}-{5}-{6}-{7}");

        /// <summary>
        /// Gets the key for caching Avalara tax code types
        /// </summary>
        public static CacheKey TaxCodeTypesCacheKey => new CacheKey("Bwr.avalara.taxcodetypes");

        /// <summary>
        /// Gets the key for caching Avalara system entity use codes
        /// </summary>
        public static CacheKey EntityUseCodesCacheKey => new CacheKey("Bwr.avalara.entityusecodes");
