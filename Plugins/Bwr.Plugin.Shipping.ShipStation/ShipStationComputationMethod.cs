...
namespace Bwr.Plugin.Shipping.ShipStation
{
    /// <summary>
    ...
    public class ShipStationComputationMethod : BasePlugin, IShippingRateComputationMethod, IMiscPlugin
    {
        ...
        public override void Install()
        {
            ...
            {
                ["Enums.Bwr.Plugin.Shipping.ShipStation.PackingType.PackByDimensions"] = "Pack by dimensions",
                ["Enums.Bwr.Plugin.Shipping.ShipStation.PackingType.PackByVolume"] = "Pack by volume",
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResources("Enums.Bwr.Plugin.Shipping.ShipStation");
