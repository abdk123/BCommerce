...
using Bwr.Plugin.Payments.PayPalSmartPaymentButtons.Domain;
...
namespace Bwr.Plugin.Payments.PayPalSmartPaymentButtons
{
    /// <summary>
    ...
    public class PaymentMethod : BasePlugin, IPaymentMethod, IWidgetPlugin
    {
        ...
        public override void Install()
        {
            ...
            {
                ["Enums.Bwr.Plugin.Payments.PayPalSmartPaymentButtons.Domain.PaymentType.Authorize"] = "Authorize",
                ["Enums.Bwr.Plugin.Payments.PayPalSmartPaymentButtons.Domain.PaymentType.Capture"] = "Capture",
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResources("Enums.Bwr.Plugin.Payments.PayPalSmartPaymentButtons");
